...
Every panel is a single file in `panels/`, toggleable and placeable in any of the three columns (L/C/R in the options window). The dashboard ships with these 23:
