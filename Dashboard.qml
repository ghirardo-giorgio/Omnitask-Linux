...
//
// Due colonne, e nessun pannello scritto qui dentro: cosa mostrare, in quale
// colonna e in che ordine lo dice Settings (modificabile dalla finestra
// Opzioni, persistito in ~/.config/quickshell/dashboard.json). Aggiungere un
// pannello nuovo significa scrivere un XxxPanel.qml e una riga nel catalogo di
// Settings — questo file non cambia.
Rectangle {
    id: root
    ...
    RowLayout {
        ...
        Repeater {
            model: [Settings.left, Settings.right]
            ...
            ColumnLayout {
                ...
                // 0 = sinistra, 1 = destra. L'indice e non un confronto fra i
                // due array: quelli arrivano dal singleton e non c'e' garanzia
                // che due letture diano lo stesso oggetto da confrontare.
                readonly property bool isRight: column.index === 1

                Layout.fillWidth: true
                Layout.fillHeight: true
                // le due colonne si dividono lo spazio a meta' qualunque sia la
